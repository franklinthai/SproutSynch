...
// The reset password page. Prompts the user to enter their email and sends them a password
// reset email.
export default function ResetPassword() {
  const [email, setEmail] = useState("");
  
  // Called when the user clicks the send reset email button. Sends a password reset email
